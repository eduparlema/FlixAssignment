...
//  FlixAssignment
//
//  Created by Eduardo Pareja Lema on 9/19/22.
//
...
class MovieGridViewController: UIViewController, UICollectionViewDataSource,
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // Pass the selected movie to the GridDetails view controller
        let gridDetailsViewController = segue.destination as! GridMovieDetailsViewController
